...
class ProductPage(BasePage):
    ...
    def should_be_correct_product_name_message(self):
        ...
        assert product_name_message.text == product_name.text, "Product name in message is not the same that product name on page"
    ...
    def should_be_correct_product_price_message(self):
        ...
        assert product_price_message.text == product_price.text, "Product price in message is not the same that product price on page"
